...
def main():
    ...
    print("="*60)
    print(f"[QuestDB] {pair} Tick Data Importer (Single-File Mode)")
    print("="*60)
    ...
    if not target_years:
        ...
        print(f"   Gebruik: python questdb_import.py {pair} --all  (voor alle jaren)")
        print(f"   Of: python questdb_import.py {pair} 2015 2016  (specifieke jaren)")
        return
